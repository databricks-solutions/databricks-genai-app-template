...
export const PREDEFINED_THEMES: PredefinedTheme[] = [
  {
    ...
    typography: {
      primaryFont: '"Montserrat", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
      secondaryFont: '"DM Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'
    },
    animatedBackground: {
      particleCount: 60,
  ...
  },
  {
    ...
    typography: {
      ...
      secondaryFont: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'
    },
    animatedBackground: {
  ...
  },
  {
    ...
    typography: {
      primaryFont: '"Roboto", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
      secondaryFont: '"Roboto", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'
    },
    animatedBackground: {
      particleCount: 60,
      connectionDistance: 65,
  ...
  },
  {
    ...
    typography: {
      primaryFont: '"Montserrat", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
      secondaryFont: '"Montserrat", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'
    },
    animatedBackground: {
